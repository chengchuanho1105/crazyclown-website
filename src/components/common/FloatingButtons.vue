...
<template>
  <div class="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
    ...
    >
      ...
      >
        <i
          class="bi bi-arrow-up text-lg group-hover:scale-110 transition-transform duration-200"
        ></i>
      </button>
    </transition>
    ...
    <div class="relative">
      ...
      >
        <i
          class="bi bi-headset text-lg group-hover:scale-110 transition-transform duration-200"
        ></i>
      </button>
    </div>
  </div>
