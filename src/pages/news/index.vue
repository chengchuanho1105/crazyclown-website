...
// 過濾資料
const regularNewsList = computed(() => newsData.value.filter((n: NewsData) => n.slot !== 'none' && n.slot !== 'featured'))
const featuredNewsList = computed(() => newsData.value.filter((n: NewsData) => n.slot === 'featured'))
