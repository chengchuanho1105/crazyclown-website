...
const HOMEHERODATA_CSV_URL =
  'https://docs.google.com/spreadsheets/d/e/2PACX-1vSvyWYaAHF29Jn2svQBJFhfZH-MKW4QfVqIG5o_a0GKTWZd2-qAxKevUe5d7qYUCgmIIVL_OMRehIVf/pub?gid=0&single=true&output=csv'
  ...
  <div class="min-h-screen">
    ...
    >
      <div class="flex">
        ...
        <div class="ml-3">
          <p class="text-sm text-yellow-700 dark:text-yellow-300">沒有找到首頁資料</p>
        </div>
      </div>
    </div>
    <template v-else>
